            ...
            @foreach($discussions as $discussion)
                ...
                <div class="card" style="margin-bottom: 20px;">
                    <div class="card-header">
                        ...
                        <span class="btn btn-danger btn-sm" style="float: right;">CLOSED</span>

                        @else

                            <span class="btn btn-success btn-sm" style="float: right;">OPEN</span>

                        @endif

                        <a href="{{ route('discussion', ['slug' => $discussion->slug]) }}" class="btn btn-info btn-sm" style="float: right;margin-right: 10px;">
                            View
                        </a>
